...
const Modelcomponent = ({ visible, onClose }) => {
    ...
    const handleOtp = (e) => {
        ...
        setloading(true);
        let requestdata = { phone: otpnumber };
        axios.post('https://projectbeatrecords.in:2130/send_otp', requestdata)
            .then((res) => {
                console.log(res);
                if (res.data.success === '1') {
                    toast.success(res.data.message);
    ...
    const handleVerify = (e) => {
        ...
        axios.post('https://projectbeatrecords.in:2130/verify_otp', requestdata)
            .then((res) => {
                console.log(res);
                if (res.data.success === '1') {
                    toast.success(res.data.message);
    ...
    const handleSubmit = (e) => {
        ...
        axios.post('https://projectbeatrecords.in:2130/send_email', requestdata)
            .then((res) => {
                console.log(res);
                if (res.data.success === '1') {
                    toast.success(res.data.message);
        ...
        <>
            ...
            {loading && (
                <div className='overlay'>
                    <img className='img-fluid' src={animation} alt="Loading..." />
                </div>
            )}
            <div className="fixed z-10 inset-0 overflow-y-auto">
                <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    ...
                    <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full relative z-0">
                        {!thanks ? (
                            <div className="bg-[#6b728029]  px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                <div className="w-full pb-5 border-b border-gray-200">
                                    <img src={logo} alt='Logo' className='mx-auto h-[45px]' />
                                    <button onClick={onClose} className='bg-white absolute top-[5px] right-[5px] rounded-full size-10 leading-1'>
                                        <CloseOutlined className='text-md font-bold' />
                                    </button>
                                </div>
                                <div className="sm:flex sm:items-start">
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        {!userform ? (
                                            showotp ? (
                                                    ...
                                                    <form onSubmit={handleOtp}>
                                                        <div className="mt-3">
                                                            <input
                                                                ...
                                                                inputMode="numeric"
                                                                className="rounded-full bg-white text-black w-full py-2 px-2 outline-none"
                                                                required
                                                                minLength={10}
                                                                maxLength={10}
                                                                autoFocus
                                                        ...
                                                        <div className="py-3 pb-6 sm:flex">
                                                            <button
                                                                className="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-8 py-2 bg-[#0d6efd] text-base font-medium text-white focus:outline-none focus:ring-2 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
                                                                disabled={loading}
                                                            >
                                                                NEXT
                                                            </button>
                                                ...
                                                <form className='otpbox'>
                                                    ...
                                                    />
                                                    <p className="text-dark font-bold mt-3 text-underline" onClick={handleOtp} style={{ fontSize: "14px", cursor: "pointer" }}>Resend Code</p>
                                                    <div className="py-3 pb-6 sm:flex">
                                                        <button
                                            ...
                                            <>
                                                <h2 className="text-2xl leading-6 font-medium text-gray-900 mt-5 text-center">Application Form</h2>
                                                <form onSubmit={handleSubmit}>
                                                    <div className="mt-3">
                                                    ...
                                                    {showOtherArea && (
                                                        <div className="mt-3">
                                                            <label htmlFor="otherArea" className="block text-sm font-medium text-gray-700">Other Area:</label>
                                                            <input
                                                                type="text"
                                                                id="otherArea"
                                                                value={otherArea}
                            ...
                            <div className="bg-[#6b728029]  px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <div className="sm:flex sm:items-start">
                                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                        <img className='h-[300px] w-[300px]' src={check} alt="Success" />
                                        <h1 className="text-xl font-semibold text-[#000] text-center">Thanks For Your Response</h1>
                                    </div>
                                </div>
                            </div>
                        )}
