                    ...
                    <div className="grid grid-cols-1">
                        <div className="col-span-1">
                            <div className="w-full text-center lg:p-20  p-10">
                                <p className="text-[#0f3695] font-bold lg:text-[1.5rem] md:text-[1.3rem] text-[10px] pb-5">DON’T HESTITATE TO CONTACT US</p>
                                <h1 className="text-[#0f3695] font-bold opacity-3 lg:text-[3rem] md:[2rem] text-[1rem]">MAKE AN APPOINTMENT NOW <span className="block font-bold text-[#c8202f] lg:text-[3rem] md:text-[2rem] text-[1rem] pt-5">8595076589</span></h1>
